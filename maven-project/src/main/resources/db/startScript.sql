...
ALTER TABLE product
  ADD CONSTRAINT product_pk PRIMARY KEY (productnr);
...
ALTER TABLE producttype
  ADD CONSTRAINT producttype_pk PRIMARY KEY (producttypenr);
...
ALTER TABLE rent
  ADD CONSTRAINT rent_pk PRIMARY KEY (rentnr);
...
ALTER TABLE status
  ADD CONSTRAINT status_pk PRIMARY KEY (statusnr);
...
ALTER TABLE userrolle
  ADD CONSTRAINT userrole_pk PRIMARY KEY (userrollenr);
